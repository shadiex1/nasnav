    ...
    render(){
        return(
            <div className={styles.Showcase}>
                ...
                <h2>sell more products with <span>google</span></h2>
                </div>
                    <div className={styles.btn}>
                        <img src={"/assets/Menu/layer-2@3x.png"}/> Watch how to do it
                    </div>
                    <div className={styles.gallery}>
                        <img className={styles.sideLeft} src={"/assets/Showcase/rounded-rectangle-41-copy@3x.png"} alt="mobile screen"/>
                        <img src={"/assets/Showcase/group-33@3x.png"} alt="mobile screen"/>
                        <img className={styles.sideRight} src={"/assets/Showcase/layer-81@3x.png"} alt="mobile screen"/>
                    </div>
                 </div>
